  ...
  /* loop to handle user input */
	while(ros::ok()){
		...
		switch(select)
		{
			...
			// 			break; 
			// 	}
			// 	a = system("rosrun rosaria_client print_state_and_teleop"); /* run option 1*/
			...
			case KEYCODE_5:
				...
				{
					case 0:
						//b = system("rosrun rosaria_client print_state");
						exit(1);
						break;
				}
			...
			case KEYCODE_7:
			{
				...
				a = system("rosrun rosaria_client zs_goal_pub"); /* run option 7 */
				a = system("rosnode kill /print_aria_state "); /*kill the ros print_state node */
				break;
			}
